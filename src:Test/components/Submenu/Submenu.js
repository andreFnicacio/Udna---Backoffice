...
export default function VerticalTabsJorney() {
  ...
  return (
    <div className={classes.root}>
      ...
      >
        <Tab label="First Journey" {...a11yProps(0)} />
        <Tab label="Second Journey" {...a11yProps(1)} />
        <Tab label="Third Journey" {...a11yProps(2)} />
        <Tab label="Fourth Journey" {...a11yProps(3)} />
        <Tab label="Fifth Journey" {...a11yProps(4)} />
        <Tab label="Final Journey" {...a11yProps(5)} />
      </Tabs>
      <nav>
