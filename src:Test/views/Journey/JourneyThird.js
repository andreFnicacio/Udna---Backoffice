      ...
      if (err) {
        ...
        setState({
          columns: [
            ...
            { title: "Kit Number", field: "nkit", type: "numeric" },
            { title: "Reason For Delay", field: "rfdelai" },
            { title: "Cód. Act.", field: "codAct", type: "numeric" },
            { title: "Cód. Lab.", field: "codLab", type: "numeric" },
            { title: "Deadline", field: "deadline", type: "numeric" },
            {
              title: "State",
              field: "state",
              lookup: { 34: "No Prazo", 63: "Fora do Prazo" },
            ...
            actions={[
              {
                ...
                onClick: (event, rowData) =>
                  alert("Parabens, Jornaca concluida :D " + rowData.cpf),
              },
            ]}
          />
        </Card>
