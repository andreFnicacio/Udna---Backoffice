...
export default function Dashboard() {
      ...
      if (err) {
        ...
        for (let i = 0; i < data.Items.length; i++){
          if(data.Items[i].status === 'paid'){
            TotalVendasDia += data.Items[i].amount;
            setTotalVendasDias(TotalVendasDia);
          }
          /**else{
  ...
  getDataByDay(`2021-0${monthCatch.toString()}-${dateCatch.toString()}T00:00:00.000Z`);
        ...
        <GridItem xs={12} sm={6} md={3}>
          <Card>
            <CardHeader color="warning" stats icon>
              ...
              <p className={classes.cardCategory}>Vendas do dia:</p>
        ...
        <GridItem xs={12} sm={6} md={3}>
          <Card>
            <CardHeader color="success" stats icon>
              ...
              <p className={classes.cardCategory}>Total do dia:</p>
              <h3 className={classes.cardTitle}>{TotalisvendasDia}</h3>
            </CardHeader>
            <CardFooter stats>
              <div className={classes.stats}>
                <DateRange />
        ...
        <GridItem xs={12} sm={6} md={3}>
          <Card>
            <CardHeader color="danger" stats icon>
              ...
              <p className={classes.cardCategory}>Vendas do mês</p>
              <h3 className={classes.cardTitle}>{vendasMes}</h3>
            </CardHeader>
            <CardFooter stats>
              <div className={classes.stats}>
                <LocalOffer />
        ...
        <GridItem xs={12} sm={6} md={3}>
          <Card>
            <CardHeader color="info" stats icon>
              ...
              <p className={classes.cardCategory}>Total do mês:</p>
              <h3 className={classes.cardTitle}>${TotalisvendasMes}</h3>
            </CardHeader>
            <CardFooter stats>
              <div className={classes.stats}>
                <Update />
